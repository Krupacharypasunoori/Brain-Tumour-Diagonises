...
def PROPOSED(population, objective_function, Xmin, Xmax, Itermax):
    """
    ...
    while Iter < Itermax:
        ...
        for i in range(NP):
            ...
            r1 = int((fitness[i] + f_XBest) / (Worstfit ** 2))  # Proposed Updation
            r2, r3 = np.random.choice([j for j in range(NP) if j != i], 2, replace=False)
